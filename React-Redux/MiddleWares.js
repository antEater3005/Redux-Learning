/* 
! use of middleware in redux
* Middleware are way to add custom functionality into redux
* It provides third party extension point between dispatching an action and the moment it reaches the reducers
! For demonstration we will use the example of shop in index.js file
